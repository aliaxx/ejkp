...
class LaporanController extends Controller
{
    ...
    public function actionGetLaporanPeniaga($jenislaporan, $TRKHMULA, $TRKHTAMAT, $IDLOKASI, $NOPETAK)
    {
        ...
        //Laporan Pegerai
            ...
            $month = date('d', strtotime($TRKHMULA));
            ...
            $content = $this->renderPartial('@backend/views/laporan/kawalanperniagaan/calendar/example', ['dataProvider' => $dataProvider, 'source' => $source]);
            
            $mpdf = new Mpdf(['orientation' => 'P']);
            $stylesheet = '<head><link rel="stylesheet" href="'.Yii::getAlias('@web').'\css\style-calendar.css'.'"/></head>';
