...
use backend\modules\penyelenggaraan\models\PerkaraJenis;
...
<div>
    <?php $form = ActiveForm::begin([
        ...
        <?= $form->field($model, 'KODKOMPONEN')->textInput(['disabled' => !$model->isNewRecord]) ?>
        ...
        <div class="form-group">
            <div class="col-lg-offset-2 col-lg-8 action-buttons">
                <?= Html::a('<i class="glyphicon glyphicon-chevron-left"></i> Kembali', Url::previous('penggredan/perkara-komponen'), [
