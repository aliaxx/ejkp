...
<div>
    <?php $form = ActiveForm::begin(); ?>
        <?= \codetitan\widgets\ActionBar::widget([
            'target' => 'primary-grid',
            'permissions' => ['new' => Yii::$app->access->can('komponen-write')],
        ]) ?>
            ...
            [
                ...
                'buttons' => [
                    'active' => function ($url, $model) {
                        ...
                        return Html::a('<span class="fa fa-toggle-off"></span>', ['delete', 'JENIS' => $model->JENIS, 'KODPERKARA' => $model->KODPERKARA, 'KODKOMPONEN' => $model->KODKOMPONEN], $options);
                    },
                    'inactive' => function ($url, $model) {
                        ...
                        return Html::a('<span class="fa fa-toggle-on"></span>', ['delete', 'JENIS' => $model->JENIS, 'KODPERKARA' => $model->KODPERKARA, 'KODKOMPONEN' => $model->KODKOMPONEN], $options);
                    },
                ],
                'visibleButtons' => [
                    'view' =>   \Yii::$app->access->can('komponen-read'),
                    'update' => \Yii::$app->access->can('komponen-write'),
                    'active' => function ($model) {
                        return \Yii::$app->access->can('komponen-write') && ($model->STATUS == OptionHandler::STATUS_TIDAK_AKTIF);
                    },
                    'inactive' => function ($model) {
                        return \Yii::$app->access->can('komponen-write') && ($model->STATUS == OptionHandler::STATUS_AKTIF);
                    },
                ],
            ],
        ],
