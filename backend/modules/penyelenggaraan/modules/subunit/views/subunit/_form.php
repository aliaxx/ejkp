...
$url['kodunit'] = Url::to(['/option/penyelenggaraan/detail', 'KODJENIS' => '24']); //this to display dropdown kodunit from tbparameterdetail --NOR180822
?>
...
<?php $form = ActiveForm::begin([
    ...
    <?= \codetitan\widgets\ActionBar::widget([
        'permissions' => ['save2close' => Yii::$app->access->can('subunit-write')],
    ]) ?>

    <?= $form->field($model, 'ID_KODUNIT')->widget(Select2::className(), [
            'pluginOptions' => [
                'allowClear' => true,
                'placeholder' => '',
                'ajax' => [
    ...
    <div class="form-group">
        <div class="col-lg-offset-2 col-lg-8 action-buttons">
            <?= Html::a('<i class="glyphicon glyphicon-chevron-left"></i> Kembali', Url::previous('subunit/subunit'), [
