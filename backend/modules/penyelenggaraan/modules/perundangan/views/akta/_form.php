...
<div>
    <?php $form = ActiveForm::begin([
        ...
        <?= \codetitan\widgets\ActionBar::widget([
            'permissions' => ['save2close' => Yii::$app->access->can('akta-write')],
        ]) ?>

        <?= $form->field($model, 'KODAKTA')->textInput(['disabled' => !$model->isNewRecord]) ?>
        <?= $form->field($model, 'PRGN')->textArea(['maxlength' => true, 'style' => 'height:140px']) ?>

        <div class="form-group">
            <div class="col-lg-offset-2 col-lg-8 action-buttons">
                <?= Html::a('<i class="glyphicon glyphicon-chevron-left"></i> Kembali', Url::previous('perundangan/akta'), [
