...
<div>
    <?php $form = ActiveForm::begin(); ?>
        <?= \codetitan\widgets\ActionBar::widget([
            'target' => 'primary-grid',
            'permissions' => ['new' => Yii::$app->access->can('akta-write')],
        ]) ?>
            ...
            [
                ...
                'buttons' => [
                    'active' => function ($url, $model) {
                        ...
                        return Html::a('<span class="fa fa-toggle-off"></span>', ['delete', 'id' => $model->KODAKTA], $options);
                    },
                    'inactive' => function ($url, $model) {
                        ...
                        return Html::a('<span class="fa fa-toggle-on"></span>', ['delete', 'id' => $model->KODAKTA], $options);
                    },
                ],
                'visibleButtons' => [
