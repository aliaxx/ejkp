...
/* @var $searchModel backend\modules\penyelenggaraan\modules\kolam\models\BacaanKolamSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Bacaan Air Kolam';
...
<div>
    <?php $form = ActiveForm::begin(); ?>
        <?= \codetitan\widgets\ActionBar::widget([
            'target' => 'primary-grid',
            'permissions' => ['new' => Yii::$app->access->can('kolam-write')],
        ]) ?>
    ...
    <?php $output = GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'visibleButtons' => [
                    'view' =>   \Yii::$app->access->can('kolam-read'),
                    'update' => \Yii::$app->access->can('kolam-write'),
                    'active' => function ($model) {
                        return \Yii::$app->access->can('kolam-write') && ($model->STATUS == OptionHandler::STATUS_TIDAK_AKTIF);
                    },
                    'inactive' => function ($model) {
                        return \Yii::$app->access->can('kolam-write') && ($model->STATUS == OptionHandler::STATUS_AKTIF);
                    },
                ],
            ],       
        ],
