...
/* @var $searchModel backend\modules\parameter\modules\pemeriksaan\models\TujuanLawatanSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Zon Ahli Majlis';
...
<div>
    <?php $form = ActiveForm::begin(); ?>
        <?= \codetitan\widgets\ActionBar::widget([
            'target' => 'primary-grid',
            'permissions' => ['new' => Yii::$app->access->can('majlis-write')],
        ]) ?>
    ...
    <?php $output = GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'visibleButtons' => [
                    'view' =>   \Yii::$app->access->can('majlis-read'),
                    'update' => \Yii::$app->access->can('majlis-write'),
                    'active' => function ($model) {
                        return \Yii::$app->access->can('majlis-write') && ($model->STATUS == OptionHandler::STATUS_TIDAK_AKTIF);
                    },
                    'inactive' => function ($model) {
                        return \Yii::$app->access->can('majlis-write') && ($model->STATUS == OptionHandler::STATUS_AKTIF);
                    },
                ],
            ],
        ],
