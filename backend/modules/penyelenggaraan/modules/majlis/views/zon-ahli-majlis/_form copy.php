...
<div>
    <?php $form = ActiveForm::begin([
        ...
        <?= $form->field($model, 'KODZON')->textInput(['disabled' => !$model->isNewRecord]) ?>
        ...
        <div class="form-group">
            <div class="col-lg-offset-2 col-lg-8 action-buttons">
                <?= Html::a('<i class="glyphicon glyphicon-chevron-left"></i> Kembali', Url::previous('penyelenggaraan/majlis'), [
