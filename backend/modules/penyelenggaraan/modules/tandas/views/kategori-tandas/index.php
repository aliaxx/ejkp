...
/* @var $searchModel backend\modules\penyelenggaraan\modules\tandas\kategori\models\KategoriTandasvektorSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Kategori Tandas';
...
?>
<div class="kategori-tandasvektor-index">

    <?php $form = ActiveForm::begin(); ?>
        <div>
            <?= \codetitan\widgets\ActionBar::widget([
                'target' => 'primary-grid',
                'permissions' => ['new' => Yii::$app->access->can('kategori-tandas-write')],
                ]) 
            ?>
        </div>
    ...
    <?php $output = GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'visibleButtons' => [
                    'view' =>   \Yii::$app->access->can('kategori-tandas-read'),
                    'update' => \Yii::$app->access->can('kategori-tandas-write'),
                    'active' => function ($model) {
                        return \Yii::$app->access->can('kategori-tandas-write') && ($model->STATUS == OptionHandler::STATUS_TIDAK_AKTIF);
                    },
                    'inactive' => function ($model) {
                        return \Yii::$app->access->can('kategori-tandas-write') && ($model->STATUS == OptionHandler::STATUS_AKTIF);
                    },
                ],
            ],       
        ],
