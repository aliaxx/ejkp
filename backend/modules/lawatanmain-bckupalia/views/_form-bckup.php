...
if (!$model->isNewRecord) {
    ...
    if ($model->PTS_JENISTANDAS) {
        $model->JENISTANDAS_ARR = explode(',', $model->PTS_JENISTANDAS);
    //     var_dump($model->JENISTANDAS_ARR);
    // exit;
    }
}
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <?php endif; ?>
                        <div class="col-md-6">
                            <div id="divAdaTandas" style="display:<?= $model->PTM_ISTANDAS == 1 ? 'block' : 'none' ?>">
                        <div class="col-md-6" >
                                <?= $form->field($model, 'JENISTANDAS_ARR')->checkboxList(common\utilities\OptionHandler::render('jenis-tandas'), ['selector'=>'checkbox', 'inline'=>true])->label('Jenis Tandas'); ?>
                            </div>
                        </div>
                    
                        <div id="divSewa" style="display:<?= $model->PTM_ISTANDAS == 2 ? 'block' : 'none' ?>">
                            <?php $checkboxTemplate = '<label class="col-sm-12 control-label pull-right"><b>Penggredan Tandas?</b></label>'; ?>
                                <?= $form->field($model, 'PTM_ISTANDAS')->checkbox(['style' => 'width: 200%; margin-right: 200%; margin-top: 10px;',
                                    'label' => $checkboxTemplate,
                                    'class' => 'checkbox-inline',
