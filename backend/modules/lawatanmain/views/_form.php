                    ...
                    <?php if ($model->IDMODULE=="PPM"): ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <?= $form->field($model, 'PTM_ISTANDAS')->checkbox(['id' => 'ptm_istandas','style' => 'width: 200%; margin-right: 200%; margin-top: 10px;',
                        ...
                        <div id="divTandas" style="display:<?= $model->PTM_ISTANDAS == 1 ? 'block' : 'none' ?>">
                            <div class="col-md-6">
...
$(document).ready(function () {
    ...
    $('#ptm_istandas').change(function() {
        var ptm_istandas = $('#ptm_istandas:checked').length;
