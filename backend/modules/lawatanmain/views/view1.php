        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    ...
                    'value' => function ($model){
                        return (!empty($model->PKK_JENISKOLAM))? $model->PKK_JENISKOLAM: null;
                    }
                ],
                [
...
<!-- ===================== Display data Maklumat Lawatan Premis Yang Diperiksa EXCEPT for Kawalan Perniagaan & Vektor ======================== -->
    ...
    <br><th style="text-align:left; padding-top:20px;"><h5><u>A. Maklumat Lesen</u></h5></th>
    <div style="float:left; width:50%;">
        <?= DetailView::widget([
            'model' => $model,
            'template' => "<tr><th style='width: 30%;'>{label}</th><td>{value}</td></tr>",
    ...
    <!-- Maklumat Lawatan Premis yang diperiksa on left side -->
    <!-- Maklumat Sewa -->
    <br><th style="text-align:left; padding-top:20px;"><h5><u>B. Maklumat Sewa</u></h5></th>
    <div style="float:left; width:50%;">
        <?= DetailView::widget([
            'model' => $model,
            'template' => "<tr><th style='width: 30%;'>{label}</th><td>{value}</td></tr>",
            'attributes' => [
                [
                    ...
                    'label' => 'No. Sewa',
                    'value' => function ($model){
                        return (!empty($model->pemilik0->NOSEWA))? $model->pemilik0->NOSEWA: null;
                    }
                ],
                [  
                    'label' => 'Lokasi',
                    'attribute' => 'LOKASIPETAK',
                    'value' => function ($model){
                        return (!empty($model->pemilik0->LOKASIPETAK))? $model->pemilik0->LOKASIPETAK: null;
                    }
                ],
            ],
        ]) ?>
        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                [
                    ...
                    'label' => 'No. Petak',
                    'value' => function ($model){
                        return (!empty($model->pemilik0->NOPETAK))? $model->pemilik0->NOPETAK: null;
                    }
                ],
                [  
                    'attribute' => 'JENISSEWA',
                    'label' => 'Jenis Sewa',
                    'value' => function ($model){
                        return (!empty($model->pemilik0->JENISSEWA))? $model->pemilik0->JENISSEWA: null;
                    }
                ],
            ],
        ]) ?>
    ...
    <br><th style="text-align:left; padding-top:20px;"><h5><u>C. Maklumat Premis</u></h5></th>
    <div style="float:left; width:50%;">
        <?= DetailView::widget([
            'model' => $model,
            'template' => "<tr><th style='width: 30%;'>{label}</th><td>{value}</td></tr>",
