...
/**
 * TranstandasSearch represents the model behind the search form of `backend\modules\peniaga\models\Transtandas`.
 */
class TranstandasSearch extends Transtandas
{
    ...
    public function rules()
    {
        return [
            [['ID'], 'number'],
            [['NOSIRI', 'KODPERKARA', 'KODKOMPONEN', 'KODPRGN', 'IDMODULE', 'KODKOMPONEN', 'KATPREMIS'], 'safe'],
