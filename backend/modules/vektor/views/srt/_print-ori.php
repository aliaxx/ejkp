...
// function and calculation for printing
...
$jumlah = Yii::$app->db->createCommand("SELECT PENCAPAIAN1 + PENCAPAIAN2 FROM TBSASARAN_SRT WHERE NOSIRI ='$sasaransrt1->NOSIRI'")->queryScalar();
...
// var_dump($model->jenisPelarut->PRGN);
// exit();
...
<div>
    ...
    <table class="sampel-table">
        ...
        <tr class="sampel-table">
            ...
            <td style="text-align:right"><b><?=$sumjumpremis?></b></td>
            <td style="text-align:right"><b><?=$sumpencapaian1?></b></td>
            <td style="text-align:right"><b><?=$sumpencapaian2?></b></td>
    ...
    <table class="sampel-table" style="width:100%">
        ...
        <tr class="sampel-table">
            ...
            <td style="text-align:right;"><b><?=$jumpremis?></b></td>
        </tr>
    </table>
    <br>
                ...
                <tr>
                    <?php 
                        if($model){
                            foreach($dalamluar1 as $dalamluar){
                                echo "<tr>";
                                echo "<td style='font-weight: bold;'>". $dalamluar->jenisRacun->PRGN ."</td>";
                                echo "<td style='font-weight: bold;text-align:right'>". number_format($dalamluar->AMAUNRACUN, 2) ."</td>";
                                echo "<td style='font-weight: bold;'>". (isset($dalamluar->jenisPelarut->PRGN) ? $dalamluar->jenisPelarut->PRGN:null) ."</td>";
                                echo "<td style='font-weight: bold;text-align:right'>". number_format($dalamluar->AMAUNPELARUT, 2) ."</td>";
                                echo "<td style='font-weight: bold;text-align:right'>". number_format($dalamluar->AMAUNPETROL, 2) ."</td>";
    ...
    <table class="sampel-table" style="width:100%">
        <thead style="color:#000000">
            <tr>
                <tr>
                    <td style="width:30%"><?= Yii::t('app', 'Jenis Racun Serangga') ?></td>
                    <td style="width:20%"><b><?=$racundalam->jenisRacun->PRGN?></b></td>
                    <td style="width:30%"><?= Yii::t('app', 'Amaun Racun Serangga Digunakan (ml)') ?></td>
                    <td style="text-align:right;width:20%"><b><?=$racundalam->AMAUNRACUN?></b></td>
                </tr>
                <tr>
                    <td><?= Yii::t('app', 'Jenis Pelarut') ?></td>
                    <td><b><?= isset($racundalam->jenisPelarut->PRGN) ? $racundalam->jenisPelarut->PRGN:null ?></b></td>
                    <td><?= Yii::t('app', 'Amaun Pelarut (ml)') ?></td>
                    <td style="text-align:right"><b><?=$racundalam->AMAUNPELARUT?></b></td>
                </tr>
                <tr>
                    <td><?= Yii::t('app', 'Bil. Caj') ?></td>
                    <td style="text-align:right"><b><?=$racundalam->BILCAJ?></b></td>
                    <td><?= Yii::t('app', 'Amaun Petrol (liter)') ?></td>
                    <td style="text-align:right"><b><?=$racundalam->AMAUNPETROL?></b></td>
                </tr>
                <tr>
                    <td><?= Yii::t('app', 'Bil. Mesin Digunakan') ?></td>
                    <td style="text-align:right"><b><?=$racundalam->BILMESIN?></b></td>
                </tr>
            </tr>
        </thead>
    </table>
    ...
    <h6 class="document-title" style="text-align:left;font-size:12px">3. PENGGUNAAN RACUN SERANGGA (LUAR RUMAH)</h6>
        ...
        <thead style="color:#000000">
            <tr>
                <tr>
                    <td style="width:30%"><?= Yii::t('app', 'Jenis Racun Serangga') ?></td>
                    <td style="width:20%"><b><?=$racunluar->jenisRacun->PRGN?></b></td>
                    <td style="width:30%"><?= Yii::t('app', 'Amaun Racun Serangga Digunakan (ml)') ?></td>
                    <td style="text-align:right;width:20%"><b><?=$racunluar->AMAUNRACUN?></b></td>
                </tr>
                <tr>
                    <td><?= Yii::t('app', 'Jenis Pelarut') ?></td>
                    <td><b><?= isset($racunluar->jenisPelarut->PRGN) ? $racunluar->jenisPelarut->PRGN:null ?></b></td>
                    <td><?= Yii::t('app', 'Amaun Pelarut (ml)') ?></td>
                    <td style="text-align:right"><b><?=$racunluar->AMAUNPELARUT?></b></td>
                </tr>
                <tr>
                    <td><?= Yii::t('app', 'Bil. Caj') ?></td>
                    <td style="text-align:right"><b><?=$racunluar->BILCAJ?></b></td>
                    <td><?= Yii::t('app', 'Amaun Petrol (liter)') ?></td>
                    <td style="text-align:right"><b><?=$racunluar->AMAUNPETROL?></b></td>
                </tr>
                <tr>
                    <td><?= Yii::t('app', 'Bil. Mesin Digunakan') ?></td>
                    <td style="text-align:right"><b><?=$racunluar->BILMESIN?></b></td>
                </tr>
            </tr>
        </thead>
    </table>
