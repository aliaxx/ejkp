    ...
    <div class="col-md-12">
        ...
        <table id="sasaranTable" class="table table-condensed table-bordered">
            <thead>
                <tr>
                    <tr>
                        <th width="20px"><?= Yii::t('app', 'Jenis Premis') ?></th>
                        <th><?= Yii::t('app', 'Jumlah Premis (200 M)') ?></th>
                        <th><?= Yii::t('app', 'Pencapaian (200 M)') ?></th>
                        <th><?= Yii::t('app', 'Pencapaian (>200 M)') ?></th>
...
function getSasaranForm(initialize)
{
    ...
    let urlItemForm = '" . Url::to(['/vektor/srt/get-sasaran-form']) . "';
...
$(document).ready(function () {
    ...
    $('#sasaransrt-form').on('click', 'button[id^=\"btnRemoveRow_\"]', function () {
        // alert('test');
