...
use backend\modules\vektor\models\Srt;
    ...
    if ($files = $model->getAttachments()) {
        foreach ($files as $key => $file) {
            ...
            $option['initialPreviewConfig'][] = [
                ...
                'downloadUrl' => Yii::getAlias('@web/' . Srt::IMAGE_PATH . '/' . basename($file)),
                'url' => Url::to([
                    '/vektor/srt/file-delete',
                    'nosiri' => $model->NOSIRI,
    ...
    <?php ActiveForm::end(); ?>
        <?= FileInput::widget([
            ...
            'pluginOptions' => [
                ...
                'uploadUrl' => Url::to(['/vektor/srt/file-upload']),
