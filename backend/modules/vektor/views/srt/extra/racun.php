...
<!-- <div class="row">
    <?php $form = ActiveForm::begin(['method' => 'post', 'options'=> ['target' => '_blank']]); ?>
        <?= \codetitan\widgets\ActionBar::widget([
            'target' => 'primary-grid',
            'permissions' => ['new' => Yii::$app->access->can('SRT-write')],
        ]) ?> 
        <div class="action-buttons">
            <?= Html::a('<i class="glyphicon glyphicon-plus-sign"></i> Daftar', ['srt/racun', 'nosiri' => $racun->NOSIRI], [
                'id' => 'action_new', 'class' => 'btn btn-success', 'name' => 'action[new]', 'value' => 1,
...
<?php $output = GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'visibleButtons' => [
                    'view' =>   \Yii::$app->access->can('SRT-read'),
                    'update' => \Yii::$app->access->can('SRT-write'),
                    'delete' => \Yii::$app->access->can('SRT-write'),
                ],
            ],
        ],
    ]); ?>
    ...
    <?php if($racun->isNewRecord): ?>
        <h4 style="margin-top:20px;">Daftar Rekod Penggunaan Racun</h4>
    <?php else : ?>
        <h4 style="margin-top:20px;">Kemaskini Rekod Penggunaan Racun 
        &nbsp;&nbsp;&nbsp;&nbsp;
        <?= Html::a('<i class="glyphicon glyphicon-plus-sign"></i> Daftar Rekod Baru', ['srt/racun', 'nosiri' => $racun->NOSIRI], [
    ...
    <div class="row">
        <div class="col-md-12">
            <span class="pull-right">
                <?= Html::a('<i class="fas fa-redo-alt"></i> Set Semula', ['srt/racun', 'nosiri' => $racun->NOSIRI], [
