...
use backend\modules\vektor\models\Ptp;
    ...
    if ($files = $model->getAttachments()) {
        foreach ($files as $key => $file) {
            ...
            $option['initialPreviewConfig'][] = [
                ...
                'downloadUrl' => Yii::getAlias('@web/' . Ptp::IMAGE_PATH . '/' . basename($file)),
                'url' => Url::to([
                    '/vektor/ptp/file-delete',
                    'nosiri' => $model->NOSIRI,
    ...
    <?php ActiveForm::end(); ?>
        <?= FileInput::widget([
            ...
            'pluginOptions' => [
                ...
                'uploadUrl' => Url::to(['/vektor/ptp/file-upload']),
