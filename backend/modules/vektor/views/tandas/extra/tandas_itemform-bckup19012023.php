...
$(document).ready(function(){
    ...
    // $('#transtandas-MO_$counter').change(function() {
        ...
        // alert (ml1);
        // alert (mk1);
        // var jum = Number(mo1)+Number(mk1)+Number(ml1)+Number(mw1);
        var jum = Number(mo1)+Number(mk1);
        // alert (jum);
        // var data = ml1+mw1+mu1+mo1+mk1;
        // alert(ml1+mw1+mu1+mo1+mk1);
        // alert($jenistandas1);
