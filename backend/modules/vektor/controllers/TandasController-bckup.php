...
class TandasController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => Yii::$app->access->can('penggredantandas-read'),
                        'actions' => ['index', 'view', 'get-ahlis', 'lokasi-am', 'gredvektor','get-item-form','get-item-form1','kodkomponen', 'gredtandas' ],
                        'roles' => ['@'],
                    ],
                    [
                        'allow' => Yii::$app->access->can('penggredantandas-write'),
    ...
    public function actionGredtandas($nosiri, $ID = null)
    {
        ...
        return $this->render('extra/gredtandas', [
            ...
            'breadCrumbs' => ['Pencegahan Vektor', 'Penggredan Tandas', $model->NOSIRI],
            'model' => $model,
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
    ...
    public function actionGetItemForm($counter, $initialize = false, $checkall = false)
    {
        ...
        // $model = $this->findModel($initialize);
        ...
        if (Yii::$app->request->isAjax) {
            ...
            A.KODPRGN, A.PRGN AS PRGN, A.MARKAH, D.ML, D.MW, D.MO, D.MU,D.MK, D.NOSIRI
            ...
            $gredtandas =  Yii::$app->db->createCommand($query)->queryAll();
                ...
                // var_dump($gredtandas->markahtandas);
                // exit();
