...
class KawalanPerniagaanController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => Yii::$app->access->can('kawalan-perniagaan-read'),
                        'actions' => ['index', 'view', 'lokasi-am', 'gerai', 'get-maklumat-sewa', 'gerai-view', 'get-gerai-delete'],
                        'roles' => ['@'],
                    ],
                    [
                        'allow' => Yii::$app->access->can('kawalan-perniagaan-write'),
    ...
    public function actionIndex()
    {
        ...
        if (Yii::$app->request->post('action')) {
            ...
            return $this->render('@backend/modules/lawatanmain/views/index', [
                'idModule' => 'KPN',
                'title' => 'Kawalan Perniagaan',
                'breadCrumbs' => ['Penggredan Premis Makanan', 'Kawalan Perniagaan'],
    ...
    /**
     * Displays a single KawalanPerniagaan model.
    ...
    public function actionView($id)
    {
        ...
        return $this->render('@backend/modules/lawatanmain/views/view', [
            'idModule' => 'KPN',
            'title' => 'Kawalan Perniagaan',
            'breadCrumbs' => ['Peniaga Kecil & Penjaja', 'Kawalan Perniagaan', $model->NOSIRI, 'Paparan Maklumat'],
            'model' => $model,
        ]);
    }

    /**
     * Creates a new KawalanPerniagaan model.
    ...
    /**
     * Updates an existing KawalanPerniagaan model.
    ...
    /**
     * Deletes an existing KawalanPerniagaan model.
    ...
    /**
     * Finds the KawalanPerniagaan model based on its primary key value.
    ...
    public function actionGetAhlis($NOSIRI = null) {
       ...
       /**
    * Get data Sewa to autofill the textbox
    */
