...
$this->params['breadcrumbs'] = [
    ...
    ['label' => 'Pemantauan Penjaja', 'url' => ['index']],
    $model->NOSIRI,
...
$modelGerai->TRKHLAWATAN_GERAI=date('d/m/y H:i', strtotime($model->TRKHMULA));
...
<?php $output = GridView::widget([
            ...
            [
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) {
                        return Html::a('<i class="glyphicon glyphicon-pencil"></i>', ['gerai', 'nosiri' => $model->NOSIRI, 'ID' => $model->ID]);
                    },
                ...
                'visibleButtons' => [
                    'view' =>   \Yii::$app->access->can('KPN-read'),
                    'update' => \Yii::$app->access->can('KPN-write'),
                    'delete' => \Yii::$app->access->can('KPN-write'),
                ],
            ],
        ],
    ]); ?>
    ...
    <?php if($modelGerai->isNewRecord): ?>
        <h4 style="margin-top:20px;">Daftar Rekod Lawatan Gerai dan Pasar</h4>
    <?php else : ?>
        <h4 style="margin-top:20px;">Kemaskini Rekod Lawatan Gerai dan Pasar
        &nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="report-master-search">
                ...
                <div class="col-md-12">  
                    <div class="row">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                            <?= $form->field($modelGerai,'lokasi')->textInput(['disable' => true])->label('Lokasi Penjaja')?>  
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
    ...
    <div class="row">
            <div class="col-md-12">
                ...
                <?php if($modelGerai->isNewRecord): ?>
                    <?= Html::a('<i class="fas fa-redo-alt"></i> Set Semula', ['gerai', 'nosiri' => $modelGerai->NOSIRI], [
