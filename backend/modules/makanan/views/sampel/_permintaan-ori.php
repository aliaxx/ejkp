...
// $sampels = Yii::$app->db->createCommand(" SELECT NOSAMPEL, JENIS_SAMPEL, TRKHSAMPEL FROM TBSAMPEL_SM
//             WHERE NOSIRI='$model->NOSIRI'
//             ORDER BY ID
//             FETCH FIRST 3 ROWS ONLY")->queryAll();
// $sampels = (new \yii\db\Query())
//     ->select('*')
//     ->from('TBSAMPEL_SM')
//     ->where(['NOSIRI' => $model->NOSIRI])
//     ->limit(3)
//     ->all();
// $sampels = $model->sampels;
...
//         $model1->TRKHSAMPEL,
//         $model1->JENIS_SAMPEL,
//         $model1->ID_JENISANALISIS1,
//         // $model1->ID_JENISANALISIS2,
//         // $model1->ID_JENISANALISIS3,
//         // $model1->JENAMA,
//         // $model1->HARGA,
//         // $model1->PEMBEKAL,
//         // $model1->CATATAN,
...
// ->select('DESIGNATION')
// ->from('MAJLIS.PRUSER')
// ->where(['like','NAME',$pgndaftar])
// ->orWhere(['NIRC'=>$pgndaftar])
// ->one();
...
<div style="padding-top:15px;text-align:justify;">
    <table class="content-table">
        <tr class="document-title" style="padding-top:15px;">
            <td>    
                <div style=" font-size: 12px;width: 240px;text-align:left;">No. Ruj: (<?= $model->NOSIRI ?>) dlm.MBPJ/060200/T/B9/UKMM/SMPL</div>
            </td>
        ...
        <tr class="document-title" style="padding-top:10px;">
            <td style="padding-top:10px;">    
                <div style=" font-size: 12px;width: 240px;text-align:left;">Juruanalisis :</div>
                <div style=" font-size: 12px;width: 240px;text-align:left;">Jabatan Kimia Petaling Jaya</div>
            ...
            <td style="padding-top:10px;">
                <div style=" font-size: 12px;text-align:right;">
                    <div>Tarikh : <?=date('d-m-Y', strtotime($model->TRKHSAMPEL)) ?></div>
                    <!-- <div>------------------------------</div> -->
                </div>
            </td>
        </tr> 
    ...
    <table class="content-table">
        <tr>
            <td style="text-align:center;padding-left:60px;padding-top:35px">
