...
<h6 class="document-title">NOTIS MAKANAN YANG DILAK/SITA</h6>
<br>
<div style="padding-top:15px;text-align:justify;">
    <table class="content-table">
        ...
        <tr class="document-title">
            <td>    
                <div style=" font-size: 13px;width: 240px;text-align:left;">K/P &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: <b><?= $model->main->NOKPPENERIMA ?></b></div>
            </td>
        </tr> 
        <tr class="document-title">
            <td>    
    ...
    <table class="content-table">
        <tr>
            <td style="padding-top:10px;text-align:justify;">    
                <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;Pada menjalankan kuasa di bawah Seksyen 4(1)(f)(g) Akta Makanan 1983, saya telah melak/menyita</div>
            </td>
        </tr>  
        <tr>
            <td style="text-align:justify;">    
                <div>makanan kepunyaan tuan/puan seperti di <b>LAMPIRAN A</b> pada : <?=date('Y-m-d', $model->main->TRKHDAFTAR)?>&nbsp; Jam :  
                    <?=date('H:i A', $model->main->TRKHDAFTAR)?>.</div>
            </td>
        </tr>  
        <br>
        <tr>
            <td style="text-align:justify;">    
                <div>2. &nbsp;&nbsp;&nbsp; Makanan/perkakas tersebut akan disimpan di: </div>
                <br>
                <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b><?=$model->main->stor->PRGN?>.</b></div>
            </td>
        </tr>  
        <br>
        <tr>
            <td style="text-align:justify;">    
                <div>3. &nbsp;&nbsp; &nbsp; <b>PERINGATAN :</b> Mana-mana orang yang mengalih, mengubah atau mengganggu dengan apa jua cara,&nbsp;&nbsp;&nbsp;</div>
            </td>
        </tr> 
        <tr>
            <td style="text-align:justify;">    
                <div> apa-apa makanan/perkakas yang dilak/sita di bawah Akta ini tanpa kuasa seorang Pegawai Berkuasa adalah </div>
            </td>
        </tr>  
        <tr>
            <td style="text-align:justify;">    
                <div>melakukan satu kesalahan dan apabila disabitkan boleh dikenakan hukuman penjara tidak melebihi satu &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>
            </td>
        </tr>  
        <tr>
            <td style="text-align:justify;">    
                <div>tahun atau denda atau kedua-duanya sekali.</div>
            </td>
        </tr>   
    </table>
    <br>
