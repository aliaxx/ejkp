...
class LawatanPemilik extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['KATEGORI_LESEN', 'KUMPULAN_LESEN', 'JENIS_JUALAN', 'JENIS_PREMIS', 'NOSSM', 'NAMASYARIKAT', 'NAMAPREMIS', 'NAMAPEMOHON', 'LOKASIPETAK', 'JENISSEWA', 'NAMAPENERIMA'], 'string', 'max' => 255],
